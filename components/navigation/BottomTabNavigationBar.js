  ...
  return (
    <StyledTabLayout>
      <StyledBottomNavigation
        ...
        <StyledBottomNavigationTab icon={CalendarIcon} isSelected={selectedIndex === 0 ? true : false} />
        <StyledBottomNavigationTab icon={BillsIcon} isSelected={selectedIndex === 1 ? true : false} />
        <StyledBottomNavigationTab icon={SettingsIcon} isSelected={selectedIndex === 2 ? true : false} />
      </StyledBottomNavigation>
    </StyledTabLayout>
  );
};
